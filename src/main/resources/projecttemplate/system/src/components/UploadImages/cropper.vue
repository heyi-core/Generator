  ...
  <div>
    <div class="cropper-content">
      ...
      <div class="cropper">
        <vue-cropper
          ref="cropper"
          :img="trueConfig.img"
          :outputSize="trueConfig.size"
          :outputType="trueConfig.outputType"
          :info="true"
          :full="trueConfig.full"
          :canMove="trueConfig.canMove"
          :canMoveBox="trueConfig.canMoveBox"
          :original="trueConfig.original"
          :autoCrop="trueConfig.autoCrop"
          :autoCropWidth="trueConfig.autoCropWidth"
          :autoCropHeight="trueConfig.autoCropHeight"
          :fixedBox="trueConfig.fixedBox"
          :fixed="trueConfig.fixed"
          :fixedNumber="trueConfig.fixedNumber"
          @realTime="realTime"
        ></vue-cropper>
      </div>
      <!-- 预览框 -->
    ...
    <div class="footer-btn">
      ...
      <div class="upload-btn">
        <el-button type="primary" @click.stop="uploadImg('blob')">上传</el-button>
      </div>
    </div>
  </div>
</template>
